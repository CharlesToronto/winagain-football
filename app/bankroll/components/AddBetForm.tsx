  ...
  return (
    ...
    >
        ...
        <div className="flex items-center gap-2 text-sm bg-white/10 rounded-lg p-1">
          <button
            ...
            className={`px-3 py-1 rounded-md ${
              mode === "combined" ? "bg-green-600 text-white" : "text-white/70"
            }`}
          >
            Paris combiné
          </button>
          <button
            ...
            className={`px-3 py-1 rounded-md ${
              mode === "simple" ? "bg-green-600 text-white" : "text-white/70"
            }`}
          >
            Paris simple
          </button>
      ...
      <button
        type="submit"
        disabled={loading}
        className="self-start px-4 py-2 rounded-lg bg-green-600 hover:bg-green-500 text-white text-sm font-semibold disabled:opacity-70"
      >
