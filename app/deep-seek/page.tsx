...
import { getGoalsForMode, resolveIsHome, type Mode } from "@/app/team/[id]/components/probabilities/GoalsScoredTrendCard";
    ...
    <div className="min-h-screen w-full p-6 text-white space-y-6">
      <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
        <div>
          ...
          <h1 className="text-3xl font-bold">Deep Seek</h1>
        </div>
      </div>
      ...
      {selectedTeam && fixtures.length > 0 ? (
        ...
        <div className="rounded-xl border border-white/10 bg-white/5 p-6 text-sm text-white/60">
          Sélectionne une équipe pour lancer Deep Seek.
        </div>
      )}
    </div>
  );
